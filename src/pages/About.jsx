        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-gray-900">
              Cổng thông tin số
              <br />
              <span className="text-blue-600">UIT Knowledge Hub</span>
            </h1>
            <p className="text-gray-500 text-lg mb-8 leading-relaxed">
              Trang web diễn đàn dành cho sinh viên UIT nhằm chia sẻ tài nguyên
              học tập, đề thi, tài liệu, kinh nghiệm nghiên cứu và hướng dẫn
              theo từng môn học, tạo môi trường trao đổi, học hỏi và hỗ trợ lẫn
              nhau trong quá trình học tập và rèn luyện.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/documents"
                className="bg-blue-700 hover:bg-blue-800 text-white font-medium py-3 px-6 rounded-full transition shadow-lg text-center"
              >
          ...
          <div className="lg:w-1/2 relative">
            <div className="w-full h-80 md:h-[450px] bg-gradient-to-tr from-blue-100 to-indigo-50 rounded-3xl relative flex items-center justify-center">
              ...
              <div className="w-4/5 h-12 bg-white/60 backdrop-blur-md rounded-full shadow-lg border border-white flex items-center px-4 gap-3 z-10">
                ...
                <div className="flex-1 bg-white/50 h-6 rounded px-2 text-xs text-gray-400 flex items-center">
                  ise-hoc-tap.vercel.app
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto">
              Chúng tôi tập trung vào việc tạo ra giá trị thực cho sinh viên
              thông qua các tiêu chí cốt lõi.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
              ...
              <p className="text-gray-500 leading-relaxed text-sm">
                Tiếp cận hàng ngàn giáo trình, tiểu luận và đề thi hoàn toàn
                miễn phí từ cộng đồng sinh viên toàn quốc.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
              ...
              <p className="text-gray-500 leading-relaxed text-sm">
                Tạo dựng mạng lưới hỗ trợ học tập giữa các khóa, các ngành và
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition">
              ...
              <p className="text-gray-500 leading-relaxed text-sm">
                Tài liệu được phân loại và đánh giá bởi chính người dùng, đảm
                bảo tính hữu ích và chính xác cao.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-teal-50 rounded-3xl h-[380px] w-full relative overflow-hidden border border-teal-100 flex justify-center items-center">
              ...
              <span className="text-teal-500 font-medium z-10">
                <img
                  ...
                  src="/img1.jpg"
                  alt="Hình ảnh sinh viên UIT Học tập"
                />
              </span>
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-1">
                    Khắc phục sự phân tán tài nguyên
                  </h4>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Sinh viên UIT hiện gặp nhiều khó khăn trong việc tìm kiếm và
                    chia sẻ tài liệu học tập, các nguồn tài nguyên đang bị phân
                    tán gây mất thời gian.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Tạo ra một không gian học tập tập trung, giúp sinh viên
                    thuận tiện trao đổi, chia sẻ tài nguyên phục vụ cho quá
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900 mb-1">
                    Xây dựng kho tài nguyên học tập mở
                  </h4>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    Hiệu quả lâu dài phục vụ hoạt động giảng dạy và nghiên cứu
                    của nhà trường, được đánh giá bởi chính người dùng.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="px-6 pb-24">
        <div className="max-w-6xl mx-auto bg-gray-900 rounded-3xl p-16 text-center text-white shadow-xl">
          ...
          <p className="text-gray-400 mb-10 max-w-xl mx-auto">
            Tham gia vào cộng đồng học thuật lớn nhất Việt Nam ngay hôm nay. Mọi
            tài liệu bạn cần đều nằm trong tầm tay.
          </p>
          <Link
            to="/documents"
            className="inline-block bg-white text-gray-900 font-bold py-3 px-10 rounded-full hover:bg-gray-100 transition shadow-lg"
          >
            Khám phá ngay
          </Link>
        </div>
